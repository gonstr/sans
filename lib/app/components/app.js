...
export default class App extends Component {
  constructor() {
    super()
    this.state = { sessions: [], fullscreen: false, mounted: false }
  }
  ...
  render() {
    const { sessions, active, fullscreen, mounted } = this.state
      ...
      <div className={styles.container}>
        <div className={cx(styles.header, { [styles.headerFullscreen]: fullscreen })}>
          {sessions.map((ses, i) => (
            ...
            >
              <span
                className={cx(styles.termHeaderText, { [styles.termHeaderTextMounted]: mounted })}
              >
                {
