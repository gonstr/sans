...
export const SPLIT_SESSION_HORIZONTALLY = 'SPLIT_SESSION_HORIZONTALLY'
export const SPLIT_SESSION_VERTICALLY = 'SPLIT_SESSION_VERTICALLY'
...
export function newTab(pwd) {
  return { type: NEW_TAB, pwd }
}
...
export function splitSessionHorizontally() {
  return { type: SPLIT_SESSION_HORIZONTALLY }
}

export function splitSessionVertically() {
  return { type: SPLIT_SESSION_VERTICALLY }
}
