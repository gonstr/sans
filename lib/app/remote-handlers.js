...
import { flattenSessionNodes } from './utils'
...
ipcRenderer.on('new-tab', () => {
  ...
  store.dispatch(Actions.newTab(activeTab.activeNode.data.pwd))
})
...
ipcRenderer.on('split-horizontally', () => store.dispatch(Actions.splitSessionHorizontally()))
ipcRenderer.on('split-vertically', () => store.dispatch(Actions.splitSessionVertically()))
